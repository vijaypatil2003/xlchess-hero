...
// INTEGRATION FIX: Direct file path tracking based on your component layout strategy
import BattleArena from "./components/BattleRoyale/BattleArena";
...
export default function App() {
  ...
  // MOUNT FIX: Appended "Battle" section target to keep structural navigation pills synced
  useEffect(() => {
    const sections = [
      "Hero",
      "Play",
    ...
    <>
      ...
      >
        ...
        <main className="relative z-10 mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-12 flex flex-col gap-36 pt-28 pb-32">
          ...
          >
            <ChessDashboard setActiveTab={setActiveTab} />
          </section>

          {/* Section 2: Interactive Play Arena */}
          <section
            id="Play"
          ...
          {/* NEW SECTION 2.5: Chess Battle Royale Cluster Arena */}
          <section
            id="Battle"
            className="min-h-[90vh] scroll-mt-28 border-t border-white/[0.03] pt-12"
          >
            <BattleArena />
          </section>

          {/* Section 3: Learn Academy */}
          <section
            id="Learn"
